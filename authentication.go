...
// BasicAuthCredentials represents the credentials required for `httpBasic` authentication.
...
func (b BasicAuthCredentials) Validate() error {
    if b.username == "" || b.password == "" {
        return errors.New("httpBasic : missing auth credentials -> Username && Password.")
    }
    return nil
}
